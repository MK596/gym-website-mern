                ...
                <Row className="g-5">
                    <Col lg={5} className="animate__animated animate__fadeInLeft">
                        <div className="pe-lg-4">
                            <h3 className="text-white text-uppercase fw-bold mb-4">Contact Information</h3>
                            <div className="d-flex align-items-center mb-4 p-3 bg-dark border-start border-primary border-3">
                            ...
                            <Card className="bg-dark border-0 p-4 mt-5 rounded-0">
